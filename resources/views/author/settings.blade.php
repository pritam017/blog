                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <form class="form-horizontal" action="{{ route('author.updateProfile') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row clearfix">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="home_with_icon_title">
                            <form class="form-horizontal" action="{{ route('author.updatePassword') }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
