...
@section('title', 'Home')
@push('css')
<link href="{{ asset('assets/frontend/css/front-page/styles.css') }}" rel="stylesheet">

<link href="{{ asset('assets/frontend/css/front-page/responsive.css') }}" rel="stylesheet">
<style>
    .favorite-post{
        color: blue;
    }
...
<div class="swiper-slide">
    <a class="slider-category" href="{{ route('postByCategory', $cat->slug) }}">
        <div class="blog-image"><img class="user_avatar" src="{{ Storage::disk('public')->url('category/slider/'. $cat->image) }}"></div>
