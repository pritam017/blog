                    ...
                    <tbody>
                        @foreach ($popular_post as $key=>$post)
                            <tr>
                                ...
                                <td>
                                    @if($post->status == true)
                                        <span class="lebel bg-cyan">Published</span>
                                        @else
                                        <span class="lebel bg-red">Pending</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('post.details', $post->slug) }}" target="_blank" class="btn btn-sm btn-primary">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
