...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <a href="{{ route('admin.post.create') }}" class="btn btn-primary pull-0">Add New</a> <br> <br>
    <div class="card">
        <div class="header">
            <h2>
                PENDING POSTS ({{ $posts->count() }})
            </h2> <br>
                ...
                <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-warning btn-sm">
                                    <i class="material-icons">visibility</i>
                                </a>
                                <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info btn-sm">
                                    <i class="material-icons">edit</i>
                                </a>
                                <button class="btn btn-danger btn-sm" onclick="deleteData({{ $post->id }})" name="delete" type="button">
                                    <i class="material-icons">delete</i>
                                </button>
                                <form action="{{ route('admin.post.destroy',$post->id)  }}" id="delete-data-{{ $post->id }}" method="POST">
                                    @csrf
                                @method('DELETE')
                            </form>
                            </td>
